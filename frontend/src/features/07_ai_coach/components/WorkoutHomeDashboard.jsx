...
const RECENT = [
  { icon: 'sprint', name: 'Metabolic Conditioning', when: 'Yesterday • 45 min', kcal: '482 kcal', bpm: '154 avg bpm' },
  { icon: 'fitness_center', name: 'Heavy Push Session', when: '2 days ago • 62 min', kcal: '315 kcal', bpm: '128 avg bpm' },
  { icon: 'pool', name: 'Active Recovery Swim', when: '3 days ago • 30 min', kcal: '220 kcal', bpm: '112 avg bpm' },
];
        ...
        <div className="flex items-center justify-between px-6 h-full">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full overflow-hidden border border-[#f5c400]/20">
              <img className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBOsqPQrFCjtbXCHVaU5Vb2t9xTItLSFTDEHOl4Dqqlmqc_vGRSHjYxzOSY1weOu-zmQpCSu8U4kL3rxJC35Z6X6HUlhr9X_FVCDCFjqCO4hlJxsWVMOwglkEL-nLBrhwwgmQ49-4G13A-ktTJ3bZxl2G9_p3aw_7terYVAUZCrMFURVBPENYXlMdjvSz8Z2429WHQbOqKvKiIgJmDsxeFvQLs5sm4d76gXA8LMPhZJzBBbzsDzEMUP5g" alt="Athlete" />
            </div>
      ...
      <main className="pt-20 px-6 space-y-6">
        ...
        <section className="flex flex-col items-center py-6 relative overflow-hidden">
          ...
          <div className="relative w-56 h-56 flex items-center justify-center">
            ...
            <div className="absolute text-center">
              ...
              <div className="mt-2 flex items-center gap-1 justify-center px-3 py-1 rounded-full bg-[#f5c400]/10 border border-[#f5c400]/20">
                <span className="material-symbols-outlined text-sm text-[#f5c400]" style={{ fontVariationSettings: "'FILL' 1" }}>bolt</span>
          ...
          <motion.button
            ...
            className="mt-6 w-full max-w-xs py-4 bg-[#f5c400] text-black font-bold text-base rounded-xl shadow-[0_4px_20px_rgba(245,196,0,0.25)] hover:brightness-110 transition-all"
          >
        ...
        <section className="grid grid-cols-12 gap-3">
          {/* Rec card */}
          <div className="col-span-8 rounded-xl p-5 relative overflow-hidden group"
            style={{ background: 'radial-gradient(at 0% 0%, rgba(245,196,0,0.06) 0px, transparent 50%), radial-gradient(at 100% 100%, rgba(245,196,0,0.04) 0px, transparent 50%), rgba(32,31,31,0.4)', backdropFilter: 'blur(24px)', border: '1px solid rgba(255,255,255,0.08)', borderTop: '1px solid rgba(255,255,255,0.12)' }}>
            ...
            <h2 className="text-base font-bold text-[#e5e2e1] mb-2">High Performance: Hypertrophy Focus</h2>
            <p className="text-xs text-[#d1c5ab] leading-relaxed mb-4">Based on elevated HRV and 8.5h sleep, we recommend posterior chain development.</p>
            <div className="flex flex-wrap gap-2">
              {['Time: 75m', 'Intensity: 8/10', 'Sets: 24'].map(t => (
            ...
            <div className="absolute bottom-[-20%] right-[-10%] w-40 h-40 opacity-5 group-hover:opacity-10 transition-opacity pointer-events-none">
              <span className="material-symbols-outlined text-[160px] text-[#f5c400]">fitness_center</span>
            </div>
          </div>

          {/* Quick metrics */}
          <div className="col-span-4 flex flex-col gap-3">
            <div className="rounded-xl p-3 flex flex-col flex-1" style={{ background: 'rgba(32,31,31,0.4)', backdropFilter: 'blur(24px)', border: '1px solid rgba(255,255,255,0.08)' }}>
              <span className="text-[9px] font-bold uppercase tracking-widest text-[#d1c5ab]">Weekly Goal</span>
              <div className="mt-2 space-y-1">
                <div className="flex justify-between items-end">
                  <span className="text-xl font-semibold text-[#e5e2e1] font-[JetBrains_Mono,monospace]">4/5</span>
            ...
            <div className="rounded-xl p-3 flex items-center justify-between" style={{ background: 'rgba(32,31,31,0.4)', backdropFilter: 'blur(24px)', border: '1px solid rgba(255,255,255,0.08)' }}>
              <div>
                <span className="text-[9px] font-bold uppercase tracking-widest text-[#d1c5ab]">HRV</span>
                <p className="text-xl font-semibold text-[#f5c400] font-[JetBrains_Mono,monospace] mt-1">78 ms</p>
              </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-3">
            ...
            <button onClick={() => navigate('/workout/history')} className="text-[11px] font-bold text-[#f5c400] hover:underline uppercase tracking-widest">View All</button>
          </div>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-[#353534] flex items-center justify-center border border-white/5">
                    <span className="material-symbols-outlined text-[#e5e2e1] text-xl">{r.icon}</span>
                  </div>
                  <div>
